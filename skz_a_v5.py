...
# -*- coding: cp1252 -*-
# C:\Users\quaestum\AppData\Local\Programs\Python\Python38\Scripts
# Baixar o Visual C++ 14.0 https://visualstudio.microsoft.com/visual-cpp-build-tools/
# https://digi.bib.uni-mannheim.de/tesseract/tesseract-ocr-setup-3.05.01dev-20170510.exe
# DOwnload no Windows https://stackoverflow.com/questions/18381713/how-to-install-poppler-on-windows
#pip install popper
#pip install Pillow
#pip install pdf2image
#pip install opencv-python
# ADD na pasta do tesseract por.traineddata
